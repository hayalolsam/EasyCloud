                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="active"><a href="listarUsuario.php"><span class="glyphicon glyphicon-globe" aria-hidden="true"></span>&nbspARQUIVOS COMPARTILHADOS</a></li>
                            ...
                            <li><a href="sobre.php"><span class="glyphicon glyphicon-question-sign" aria-hidden="true"></span>&nbsp SOBRE</a></li></li>
                        </ul>
